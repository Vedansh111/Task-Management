            ...
            <div className='p-6'>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div className="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                        ...
                        <div className="text-[#f84525] font-medium text-sm hover:text-red-800">View</div>
                    </div>
                </div>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="relative w-full">
                                                        <div className="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                                                            <div className="shadow-none flex w-[70%] flex-col text-center whitespace-nowrap text-white justify-center bg-blue-600"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr className="text-gray-700 dark:text-gray-100">
                                            ...
                                            <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="relative w-full">
                                                        <div className="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                                                            <div className="shadow-none flex flex-col text-center w-[40%] whitespace-nowrap text-white justify-center bg-blue-500"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td className="py-2 px-4 border-b border-b-gray-50">
                                            <div className="flex items-center">
                                                <div className="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate">Lorem Ipsum</div>
                                            </div>
                                        </td>
                                        <td className="py-2 px-4 border-b border-b-gray-50">
