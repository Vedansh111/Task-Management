...
function HoverComponent(props) {
    return (
        <li className="mb-1 group text-balance">
            <NavLink to={props.to}
                className={({ isActive }) => `animate-fade-right animate-once animate-ease-out flex font-semibold items-center py-2 px-2 hover:bg-gray-950 hover:text-gray-100 hover:rounded-md rounded-md 
