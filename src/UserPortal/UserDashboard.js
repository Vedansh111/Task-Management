...
function UserDashboard() {
    ...
    return (
        tasks ? (
            <div onClick={showSettings} className='p-6 lg:h-[89vh] md:h-full sm:h-full'>
                {/* Upper Div - ["No. of users", "No. of events", "No. of something"] */}
                <div className="h-[18%] grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:mb-5 md:mb-6 sm:mb-6">
